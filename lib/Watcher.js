...
function Watcher(configWatcher, master) {
    ...
    this.email = EmailTemplate.validate(new EmailTemplate(configWatcher.emailTemplate))
...
Watcher.prototype.checkSubreddit = function (callback) {
    ...
    this.getPosts(function (loadedPosts) {
...
Watcher.prototype.getPosts = function (callback) {
    ...
    request({'url': REDDIT_SUBREDDIT_BASE_URL + this.subreddit + REDDIT_PAGE_ARGUMENTS},
        (function (error, response, body) {
            if (!error && response.statusCode == 200) {
                ...
                callback(JSON.parse(body).data.children.map(function (post) {
...
Watcher.prototype.logEmailSuccess = function () {
    ...
    + this.email.to + ' via ' + this.master.getService() + '.');
};
